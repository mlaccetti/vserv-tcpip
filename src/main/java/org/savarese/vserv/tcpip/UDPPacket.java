...
public class UDPPacket extends IPPacket {
	 ...
	 * 
	 * @param length
	 *          The length of the UDP packet in bytes.
	 */
	 ...
	 * 
	 * @param length
	 *          The length of the UDP data payload in bytes.
	 */
	 ...
	 * 
	 * @param update
	 *          Specifies whether or not to update the UDP checksum header after
